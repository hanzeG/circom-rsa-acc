...
// describe("Test pow_mod_bits_1024_1024_64.circom: pow_mod for random 1024-bit N with random 1024-bit exp and random 64-bit base", function () {
//     this.timeout(1000 * 1000);
...
//     before(async function () {
//         circuit = await wasm_tester(path.join(__dirname, "circuits", "pow_mod_bits_1024_1024_64.circom"));
//         rsa_arb = await RSA_ARB.initialize(secret_bit, exp_bit);
//     });
...
//         const input = {
//             base: plaintext_array,
//             exp: bigintToBitsArray(rsa_arb.exp, exp_bit),
//             modulus: n_array
//         };

//         // Save the input object to a JSON file at relative path "../circuit_input"
//         const outputPath = path.join(__dirname, "../circuit_input/pow_mod_bits_1024_1024_64.json");
//         fs.writeFileSync(outputPath, JSON.stringify(input, null, 2));
